...
$string['error:CIEID_NOT_FOUND'] = 'CIEID_NOT_FOUND - CieID doesn\'t exists. Please verify your settings. Without a valid CieID you cannot create activities!';
$string['error:APIID_NOT_FOUND'] = 'APIID_NOT_FOUND - ApiID doesn\'t exists. Please verify your settings. Without a valid ApiID you cannot create activities!';
$string['error:URL_ERROR'] = 'URL_ERROR - The API\'s URL doesn\'t exist. Please verify your settings. Without an the API\'s URL you cannot create activities!';
